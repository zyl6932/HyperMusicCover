...
import com.os4.musiccover.ui.component.animation.DampedDragAnimation
import com.os4.musiccover.ui.component.animation.InteractiveHighlight
...
internal fun IosLiquidGlassNavigationBar(
    ...
    Column(modifier = modifier.fillMaxWidth()) {
        Box(
            modifier = Modifier
                .padding(bottom = bottomPaddingValue, start = 36.dp, end = 36.dp)
                .fillMaxWidth(),
